...
export const INFRA_NETWORK_HERO = {
  ...
  sub:
    'Structured to match the Infrastructure network datasheet in your service library: clear scope boundaries, evidence-first narratives, cross-correlated ASM, AD Suite, ToIP, and portal-backed tracking from first finding through retest.',
} as const
...
export const INFRA_NETWORK_EDGE = {
  ...
  methodologyLead:
    'Every engagement runs five converging pipelines — ASM, SAST, AD Suite, ToIP, and Nuclei — all cross-correlated via the OffSec Management Portal.',
  pillars: [
    {
    ...
    {
      title: 'ToIP intelligence engine',
...
export const INFRA_NETWORK_METHODOLOGY = {
  ...
  phases: [
    ...
    },
    {
      ...
      title: 'Analyze',
      body:
        'ToIP generates infrastructure-specific attack playbooks. AD Suite maps privilege escalation paths and domain compromise chains. Network topology analysis surfaces segmentation weaknesses and lateral movement opportunities.',
    },
    {
      step: '3',
      title: 'Attack',
