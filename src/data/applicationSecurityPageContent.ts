...
export const APP_SEC_HERO = {
  ...
  lead:
    'Business logic-aware testing of web apps, APIs, mobile, and source code — powered by AI-validated SAST and Technieum OffSec Intelligence Portal. Browser, API, mobile, architecture, and code-level testing with exploitability you can defend in sprint planning and release gates.',
  sub:
    'Structured to align with the application security datasheet: OWASP-aligned cases, AI-validated SAST and SCA where they help, Technieum OffSec Intelligence Portal-backed playbooks, and human validation before severity hits your backlog.',
} as const
...
export const APP_SEC_KEY_BENEFITS = {
  ...
  items: [
    ...
    {
      title: 'Agentic AI-validated SAST pipeline',
      body:
        'Source code to logic extraction, Technieum OffSec Intelligence Portal playbooks, and validated exploits: automated analysis, then human validation.',
    },
    {
...
export const APP_SEC_SOLUTION_INTRO = {
  ...
  intro:
    'Technieum combines AI-powered static analysis with dynamic testing, manual code review, and SCA — all cross-correlated through Technieum OffSec Intelligence Portal intelligence.',
} as const
...
export const APP_SEC_SERVICE_CATALOG = [
  ...
  {
    step: '5',
    title: 'Source code review (AI-validated SAST)',
    body:
...
export const APP_SEC_EDGE = {
  ...
  methodologyLead:
    'Agentic AI-validated SAST pipeline: source code to AI analysis, business logic extraction, Technieum OffSec Intelligence Portal playbooks, exploit creation, and human validation.',
  pillars: [
    {
    ...
    {
      title: 'Technieum OffSec Intelligence Portal attack playbooks',
  ...
  phases: [
    {
      ...
      title: 'Discover',
      body:
        'Application reconnaissance maps endpoints, authentication flows, API schemas (REST, GraphQL, SOAP), mobile binary analysis, and technology stack fingerprinting. AI-validated SAST performs initial source analysis to extract business logic patterns.',
    },
    {
      step: '2',
      title: 'Analyze',
      body:
        'AI-validated SAST extracts authentication, authorization, and transaction logic from source. Technieum OffSec Intelligence Portal generates application-specific attack playbooks. SCA maps dependency risks with exploitability scoring. Threat models reflect your architecture.',
    },
    {
      step: '3',
      title: 'Attack',
