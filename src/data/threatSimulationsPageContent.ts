...
export const THREAT_SIM_METHODOLOGY = {
  ...
  phases: [
    ...
    },
    {
      ...
      title: 'Analyze',
      body:
        'Campaign design with custom pretexts, clone portals for credential harvesting, vishing scripts, MFA bypass technique selection (push fatigue, AiTM). ToIP social intelligence improves pretext credibility.',
    },
    {
      step: '3',
      title: 'Attack',
