...
const scanLines = SAST_LAUNCH_SCAN_LINES
const phases = SAST_LAUNCH_PHASES

export function SastPortalLaunchUI({ loop = true, onComplete, className = '', compact = false }: Props) {
