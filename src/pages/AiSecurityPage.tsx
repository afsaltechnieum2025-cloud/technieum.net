...
export function AiSecurityPage() {
  const { visualNodes, visualAriaLabel, pillars, outcomes, deliverables } = aiSecurityHubConfig
    ...
    <main id="main-content" className="flex flex-col bg-page">
      <section className="section-zz-a section-zz-wash-tl relative overflow-hidden bg-bg-inset py-14 md:py-20">
        ...
        <div className="container relative z-10">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <div>
              <p className="text-shimmer-brand mb-3 text-xs font-semibold tracking-wide md:text-sm">{AI_SEC_HERO.eyebrow}</p>
              <h1 className="heading-scale-hero mb-4 max-w-xl text-pretty">{AI_SEC_HERO.title}</h1>
              <p className="mb-3 max-w-xl text-sm font-medium leading-relaxed text-zinc-200 md:text-base">{AI_SEC_HERO.lead}</p>
              <p className="mb-8 max-w-xl text-sm leading-relaxed text-muted">{AI_SEC_HERO.sub}</p>
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <ul className="m-0 grid list-none gap-4 p-0 md:grid-cols-3">
            {AI_SEC_KEY_BENEFITS.items.map((b) => (
              <li
                key={b.title}
      ...
      <section className="section-zz-a section-zz-wash-tl bg-bg-inset py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <h2 className="mb-3 text-lg font-semibold text-heading md:text-xl">{AI_SEC_PARTNER.title}</h2>
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <p className="mb-10 max-w-3xl text-sm leading-relaxed text-muted">{AI_SEC_SOLUTION_INTRO.intro}</p>
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <p className="mb-8 max-w-3xl text-sm leading-relaxed text-muted">{AI_SEC_EDGE.methodologyLead}</p>
          <ul className="m-0 grid list-none gap-4 p-0 sm:grid-cols-2 lg:grid-cols-3">
            {AI_SEC_EDGE.pillars.map((p) => (
      ...
      <section className="section-zz-a section-zz-wash-tl bg-bg-inset py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <p className="mb-8 max-w-3xl text-sm leading-relaxed text-muted">{AI_SEC_INDUSTRY_VERTICALS.intro}</p>
          <ul className="m-0 grid list-none gap-4 p-0 md:grid-cols-2">
            {AI_SEC_INDUSTRY_VERTICALS.verticals.map((v) => (
              <li key={v.title} className="rounded-xl border border-border bg-panel/30 p-5">
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <p className="mb-8 max-w-3xl text-sm leading-relaxed text-muted">{AI_SEC_METHODOLOGY.intro}</p>
          <ol className="m-0 grid list-none gap-3 p-0 lg:grid-cols-5">
            {AI_SEC_METHODOLOGY.phases.map((ph) => (
              <li
                key={ph.step}
      ...
      <section className="section-zz-a section-zz-wash-tl bg-bg-inset py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <p className="mb-8 max-w-3xl text-sm leading-relaxed text-muted">{AI_SEC_DELIVERABLE_REPORTS.intro}</p>
          <ul className="m-0 mb-10 grid list-none gap-4 p-0 sm:grid-cols-2">
            {AI_SEC_DELIVERABLE_REPORTS.pdfCore.map((d) => (
          ...
          <ul className="m-0 flex list-none flex-col gap-3 p-0">
            ...
            {AI_SEC_DELIVERABLES_PROGRAM_EXTRA.map((d) => (
              <li key={d} className="flex gap-3 text-sm leading-relaxed text-muted md:text-base">
                <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-brand" aria-hidden />
                <span>{d}</span>
              </li>
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-3xl">
          ...
          <p className="m-0 text-sm leading-relaxed text-muted">{AI_SEC_STANDARDS.certifications}</p>
        </div>
        </div>
      </section>
