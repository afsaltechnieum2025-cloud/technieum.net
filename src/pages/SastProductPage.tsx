    ...
    <main id="main-content" className="flex flex-col bg-page">
      <section className="section-zz-a relative overflow-hidden bg-bg-inset py-14 md:py-20">
        ...
        <div className="container relative z-10">
          ...
          <p className="mb-8 max-w-3xl text-base leading-snug text-brand md:text-lg">{HOME_SAST.subtitle}</p>

          <p className="mb-6 max-w-3xl text-sm leading-relaxed text-muted md:text-base">{SAST_HERO.lead}</p>
          ...
          <p className="mb-10 text-xs text-muted/80">{SAST_HERO.preparedBy}</p>
