    ...
    <main id="main-content" className="flex flex-col bg-page">
      ...
      <section className="section-zz-a section-zz-wash-tl bg-panel/15 pt-14 md:pt-20 pb-8 md:pb-10">
        <div className="container">
          ...
          <p className="mb-8 text-sm leading-relaxed text-muted md:text-base">{ASM_INTERACTION.intro}</p>
      ...
      <section className="section-zz-b section-zz-wash-br pt-8 md:pt-10 pb-14 md:pb-20">
        <div className="container">
          ...
          <p className="mb-0 text-sm leading-relaxed text-muted md:text-base">{ASM_PIPELINE.subtitle}</p>
          <ProductPipelinePhases
            phases={ASM_PIPELINE.phases}
            ariaLabel="ASM pipeline from scope to portal-ready output"
          />
        </div>
      </section>
