...
export function CloudSecurityPage() {
  const { visualNodes, visualAriaLabel, pillars, outcomes, deliverables } = cloudSecurityHubConfig
      ...
      <section className="section-zz-a section-zz-wash-tl relative overflow-hidden bg-bg-inset py-14 md:py-20">
        ...
        <div className="container relative z-10">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <div>
              <p className="text-shimmer-brand mb-3 text-xs font-semibold tracking-wide md:text-sm">{CLOUD_SEC_HERO.eyebrow}</p>
              <h1 className="heading-scale-hero mb-4 max-w-xl text-pretty">{CLOUD_SEC_HERO.title}</h1>
              <p className="mb-3 max-w-xl text-sm font-medium leading-relaxed text-zinc-200 md:text-base">{CLOUD_SEC_HERO.lead}</p>
              <p className="mb-8 max-w-xl text-sm leading-relaxed text-muted">{CLOUD_SEC_HERO.sub}</p>
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <ul className="m-0 grid list-none gap-4 p-0 md:grid-cols-3">
            {CLOUD_SEC_KEY_BENEFITS.items.map((b) => (
              <li
                key={b.title}
      ...
      <section className="section-zz-a section-zz-wash-tl bg-bg-inset py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <ol className="m-0 grid list-none gap-3 p-0 lg:grid-cols-5">
            {CLOUD_SEC_METHODOLOGY.phases.map((ph) => (
              <li
                key={ph.step}
      ...
      <section className="section-zz-b section-zz-wash-br py-12 md:py-16">
        <div className="container"><div className="container-inner-5xl">
          ...
          <ul className="m-0 mb-10 grid list-none gap-4 p-0 sm:grid-cols-2">
            {CLOUD_SEC_DELIVERABLE_REPORTS.pdfCore.map((d) => (
          ...
          <ul className="m-0 flex list-none flex-col gap-3 p-0">
            ...
            {CLOUD_SEC_DELIVERABLES_PROGRAM_EXTRA.map((d) => (
              <li key={d} className="flex gap-3 text-sm leading-relaxed text-muted md:text-base">
                <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-brand" aria-hidden />
                <span>{d}</span>
              </li>
