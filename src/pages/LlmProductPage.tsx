...
export function LlmProductPage({ doc }: { doc: ProductDocument }) {
  ...
  const screenshotTour =
    productHasScreenshotFolder(doc.id) && slides.length > 0 ? (
      <section className="section-zz-b py-14 md:py-20" aria-labelledby="llm-screenshots-heading">
        <div className="container">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              <h2 id="llm-screenshots-heading" className="mb-3 text-xl font-medium text-heading md:text-2xl">
                {HOME_LLM.title}
              </h2>
              <p className="mb-6 text-base leading-snug text-brand">{HOME_LLM.subtitle}</p>
              <p className="mb-8 text-sm leading-relaxed text-muted lg:mb-0">{HOME_LLM.intro}</p>
              <ul className="m-0 mt-8 list-none space-y-4 p-0 lg:mt-10">
                {HOME_LLM.bullets.map((b) => (
    ...
    <main id="main-content" className="flex flex-col bg-page">
      <section className="section-zz-a relative overflow-hidden bg-bg-inset py-14 md:py-20">
        ...
        <div className="container relative z-10">
          ...
          <p className="mb-8 max-w-3xl text-base leading-snug text-brand md:text-lg">{HOME_LLM.subtitle}</p>

          <p className="mb-6 max-w-3xl text-sm leading-relaxed text-muted md:text-base">{LLM_HERO.lead}</p>
      ...
      <section className="section-zz-b py-14 md:py-20">
        <div className="container">
          ...
          <p className="mb-2 max-w-2xl text-sm text-muted md:text-base">{LLM_PIPELINE.subtitle}</p>
      ...
      <section className="section-zz-a bg-panel/15 py-14 md:py-20">
        <div className="container max-w-4xl">
          ...
          <p className="mb-8 text-sm leading-relaxed text-muted md:text-base">{LLM_AI.intro}</p>
          <ul className="m-0 space-y-4 p-0">
            {LLM_AI.points.map((p, i) => (
              <li
                key={i}
      ...
      <section className="section-zz-b py-14 md:py-20">
        <div className="container">
          ...
          <p className="mb-10 max-w-3xl text-sm text-muted md:text-base">{LLM_OUTPUTS.intro}</p>
      ...
      <section className="section-zz-a py-14 md:py-20">
        <div className="container max-w-4xl">
          <h2 className="mb-8 text-xl font-medium text-heading md:text-2xl">{LLM_TECH_STACK.title}</h2>
          <div className="overflow-hidden rounded-xl border border-border bg-panel/25">
            {LLM_TECH_STACK.rows.map((row, i) => (
              <div
                key={row.layer}
      ...
      <section className="section-zz-a bg-panel/20 py-14 md:py-20">
        <div className="container">
          ...
          <p className="mx-auto mt-10 max-w-2xl text-center text-xs leading-relaxed text-muted/70">
            {LLM_PAGE_META.confidentialNote}
          </p>
        </div>
      </section>
