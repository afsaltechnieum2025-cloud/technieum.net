...
import {
  ...
  INFRA_NETWORK_CTA,
  INFRA_NETWORK_DELIVERABLE_REPORTS,
  INFRA_NETWORK_DELIVERABLES_PROGRAM,
  INFRA_NETWORK_EDGE,
  INFRA_NETWORK_HERO,
  INFRA_NETWORK_KEY_BENEFITS,
  INFRA_NETWORK_METHODOLOGY,
  INFRA_NETWORK_PARTNER,
  INFRA_NETWORK_PILLARS,
  INFRA_NETWORK_SERVICE_CATALOG,
  INFRA_NETWORK_SOLUTION_INTRO,
    ...
    <main id="main-content" className="flex flex-col bg-page">
      ...
      <section className="relative overflow-hidden bg-black py-6 md:py-8">
        <div className="container">
          <div className="container-inner-5xl">
            <h2 className="mb-1.5 text-[0.65rem] font-bold uppercase tracking-[0.16em] text-brand sm:text-xs md:text-[0.8125rem]">
              {INFRA_NETWORK_SOLUTION_INTRO.title}
            </h2>
            <p className="mb-2 text-sm font-medium text-zinc-500">{INFRA_NETWORK_SOLUTION_INTRO.subtitle}</p>
            <p className="mb-4 max-w-3xl text-sm leading-relaxed text-muted sm:mb-5">
              {INFRA_NETWORK_SOLUTION_INTRO.intro}
            </p>
            <ol className="m-0 grid min-w-0 list-none grid-cols-1 gap-3 p-0 md:grid-cols-2 md:gap-4">
              {INFRA_NETWORK_SERVICE_CATALOG.map((s) => {
      ...
      <section className="relative overflow-hidden bg-black py-6 md:py-8">
        <div className="container">
          <div className="container-inner-5xl">
            <h2 className="mb-1.5 text-[0.65rem] font-bold uppercase tracking-[0.16em] text-brand sm:text-xs md:text-[0.8125rem]">
              {INFRA_NETWORK_EDGE.title}
            </h2>
            <p className="mb-2 text-sm font-medium text-zinc-500">{INFRA_NETWORK_EDGE.subtitle}</p>
            <p className="mb-4 max-w-3xl text-sm leading-relaxed text-muted sm:mb-5">
              {INFRA_NETWORK_EDGE.methodologyLead}
            </p>
            <ul className="m-0 grid min-w-0 list-none grid-cols-1 gap-3 p-0 md:grid-cols-2 md:gap-4">
              {INFRA_NETWORK_EDGE.pillars.map((p, index) => {
                const watermark = String(index + 1).padStart(2, '0')
                return (
                  <li
                    key={p.title}
      ...
      <section className="relative overflow-hidden bg-black py-6 md:py-8">
        <div className="container min-w-0">
          <div className="container-inner-5xl min-w-0">
            <h2 className="mb-1.5 text-[0.65rem] font-bold uppercase tracking-[0.16em] text-brand sm:text-xs md:text-[0.8125rem]">
              {INFRA_NETWORK_DELIVERABLE_REPORTS.subtitle}
            </h2>
            <p className="mb-2 text-sm font-medium text-zinc-500">{INFRA_NETWORK_DELIVERABLE_REPORTS.title}</p>
            <p className="mb-4 max-w-3xl text-pretty text-sm leading-relaxed text-muted sm:mb-5">
              {INFRA_NETWORK_DELIVERABLE_REPORTS.intro}
            </p>
            <ul className="m-0 grid min-w-0 list-none grid-cols-1 gap-3 p-0 md:grid-cols-2 md:gap-4">
              {INFRA_NETWORK_DELIVERABLE_REPORTS.pdfCore.map((d, index) => {
                const watermark = String(index + 1).padStart(2, '0')
                return (
                  <li
                    key={d.title}
            ...
            <div className="mt-6 border-t border-white/[0.06] pt-6 md:mt-7 md:pt-7">
              ...
              <ul className="m-0 grid min-w-0 list-none grid-cols-1 gap-3 p-0 md:grid-cols-2 md:gap-4">
                {INFRA_NETWORK_DELIVERABLES_PROGRAM.map((line, index) => {
                  const watermark = String(index + 1).padStart(2, '0')
                  return (
                    <li
                      key={line}
      ...
      <section className="section-zz-b section-zz-wash-br py-8 md:py-12">
        <div className="container min-w-0">
          <div className="container-inner-5xl min-w-0 text-left">
            <h2 className="mb-2 text-lg font-semibold text-heading md:text-xl">{INFRA_NETWORK_CTA.title}</h2>
            <p className="mb-5 max-w-3xl text-pretty text-sm leading-relaxed text-muted md:mb-6">
              {INFRA_NETWORK_CTA.body}
            </p>
