...
function AdPipeline({ motion }: { motion: boolean }) {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="AD Suite pipeline from scoped run to evidence-backed exports"
    >
      ...
      <section className="section-zz-b pt-8 md:pt-10 pb-14 md:pb-20">
        <div className="container">
          <div className="mx-auto max-w-6xl">
            ...
            <p className="mb-0 max-w-2xl text-sm leading-relaxed text-muted md:text-base">{AD_PIPELINE.subtitle}</p>
